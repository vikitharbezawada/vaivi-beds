...
export const metadata: Metadata = {
  title: "Contact Vaivi Beds | Custom Beds in Hyderabad",
  description:
      ...
      <main className="flex-1 pt-[4.5rem] sm:pt-20">
        <div className="section-padding max-w-full overflow-x-hidden !pt-10 md:!pt-16">
          <div className="max-w-5xl mx-auto mb-10 md:mb-16">
            <p className="label-uppercase mb-4">Contact Vaivi</p>
            <h1 className="font-heading text-3xl md:text-5xl font-medium tracking-tight mb-6">
              Let&apos;s Talk About Your Room
            </h1>
            <p className="text-muted-foreground text-sm max-w-md">
              Ask us about a design, a material or a tricky room. We&apos;re happy
              to help before you decide anything.
            </p>
          </div>
        ...
        <div className="w-full h-[50vh] min-h-[400px] relative border-t border-border/40 bg-muted">
          <iframe
            title="Vaivi Beds on Google Maps"
            src={embedSrc}
          ...
          <div className="absolute bottom-6 right-6 z-10">
            <a
              ...
              className="bg-background text-foreground px-6 py-3 text-sm font-medium shadow-md hover:opacity-90 transition-opacity rounded-sm"
            >
              View Larger Map
            </a>
          </div>
