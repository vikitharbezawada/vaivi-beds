  ...
  return (
    <>
      ...
      <main className="flex-1 section-padding pt-[4.5rem] sm:pt-20 flex flex-col items-center justify-center min-h-[55vh] sm:min-h-[60vh] text-center px-2">
        ...
        <Link
          href="/"
          className="bg-accent text-accent-foreground px-8 py-3.5 text-sm font-semibold uppercase tracking-wider inline-flex min-h-11 items-center justify-center w-full max-w-xs sm:w-auto"
        >
          Back home
        </Link>
      </main>
